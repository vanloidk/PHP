 ...
 * @license 
 */
class Controller_Products_necklaceSaleOff extends Controller_Base {
    ...
    public function action_index() {
        ...
        $config = array(
            ...
            'first-marker'   => 'First',
            'last-marker'    => 'Last',
            'pagination_url' => 'http://localhost:8080/saleonline/html/products/necklaceSaleOff/',
        ...
        $pagination = Fuel\Core\Pagination::forge('products/necklaceSaleOff/', $config);
        $tproduct   = Model_Tproduct::getProductsSaleOffByName($pagination, Input::post('txt_search'), 3);

        $view                         = View::forge('products/necklaceSaleOff/index');
        $view->necklaces              = $tproduct;
        $view->pagination             = $pagination;
        $this->template->title        = "Dây chuyền giảm giá";
    ...
    public function action_detail($id = null) {
        ...
        $view     = View::forge('products/necklaceSaleOff/detail');
    ...
    public function action_cart($id = null) {
        ...
        Response::redirect('products/necklaceSaleOff/');
    }
    ...
    public function action_edit($id = null) {
        ...
        $view                         = View::forge('necklaceSaleOff/edit');
    ...
    public function action_search() {
        ...
        $product = Model_Tproduct::countProductsByName($pagination, Input::post('txt_search'), 1);
