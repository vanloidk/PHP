 ...
 * @license X-TRANS Develop License 1.0
 */
class Controller_Products_jewelrybox extends Controller_Base {
    ...
    public function action_index() {
        ...
        $config = array(
            ...
            'first-marker'   => 'First',
            'last-marker'    => 'Last',
            'pagination_url' => 'http://localhost:8080/saleonline/html/products/jewelrybox/',
        ...
        $tproduct   = Model_Tproduct::getProductsByName($pagination, Input::post('txt_search'), 5);

        $view                         = View::forge('products/jewelrybox/index');
        $view->jewelryboxs            = $tproduct;
        $view->pagination             = $pagination;
        $this->template->title        = "Hộp đựng trang sức";
    ...
    public function action_detail($id = null) {
        ...
        $view     = View::forge('products/jewelrybox/detail');
    ...
    public function action_cart($id = null) {
        ...
        Response::redirect('products/jewelrybox/');
    }
    ...
    public function action_search() {
        ...
        $config      = array(
            ...
            'first-marker'   => 'First',
            'last-marker'    => 'Last',
            'pagination_url' => 'http://localhost:8080/saleonline/html/jewelrybox/laptop/',
            'total_items'    => $total_items,
            'per_page'       => PER_PAGE,
            // or if you prefer pagination by query string
            'uri_segment'    => 'page',
        ...
        $pagination = Fuel\Core\Pagination::forge('products/jewelrybox/', $config);
