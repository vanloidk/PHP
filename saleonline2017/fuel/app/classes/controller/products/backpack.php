...
class Controller_Products_backpack extends Controller_Base {
    ...
    public function action_index() {
        ...
        $tproduct   = Model_Tproduct::getProductsByName($pagination, Input::post('txt_search'), 7);
    ...
    public function action_search() {
        ...
        $product = Model_Tproduct::getProductsByName($pagination, Input::post('txt_search'), 7);
