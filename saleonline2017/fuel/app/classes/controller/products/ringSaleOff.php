 ...
 * @license 
 */
class Controller_Products_ringSaleOff extends Controller_Base {
    ...
    public function action_index() {
        ...
        $config      = array(
            ...
            'first-marker'   => 'First',
            'last-marker'    => 'Last',
            'pagination_url' => 'http://localhost:80/saleonline/html/products/ringSaffOff/',
        ...
        $tproduct   = Model_Tproduct::getProductsSaleOffByName($pagination, Input::post('txt_search'), 2);
    ...
    public function action_detail($id = null) {
        ...
        $view     = View::forge('products/ringSaleOff/detail');
    ...
    public function action_search() {
        ...
        $config      = array(
            ...
            'first-marker'   => 'First',
            'last-marker'    => 'Last',
            'pagination_url' => 'http://localhost:8080/saleonline/html/products/ringSaleOff/',
            'total_items'    => $total_items,
            'per_page'       => PER_PAGE,
            // or if you prefer pagination by query string
            'uri_segment'    => 'page',
        ...
        $product = Model_Tproduct::getProductsSaleOffByName($pagination, Input::post('txt_search'), 2);
