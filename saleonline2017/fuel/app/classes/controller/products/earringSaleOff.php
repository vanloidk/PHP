 ...
 * @license 
 */
class Controller_Products_earringSaleOff extends Controller_Base {
    ...
    public function action_index() {
        ...
        $config = array(
            ...
            'first-marker'   => 'First',
            'last-marker'    => 'Last',
            'pagination_url' => 'http://localhost:8080/saleonline/html/products/earringSaleOff/',
        ...
        $pagination = Fuel\Core\Pagination::forge('products/earringSaleOff/', $config);
        $earrings   = Model_Tproduct::getProductsSaleOffByName($pagination, Input::post('txt_search'), 6);

        $view                         = View::forge('products/earringSaleOff/index');
        $view->earrings               = $earrings;
        $view->pagination             = $pagination;
        $this->template->title        = "Bông tai giảm giá";
    ...
    public function action_detail($id = null) {
        ...
        $view     = View::forge('products/earringSaleOff/detail');
    ...
    public function action_cart($id = null) {
        ...
        Response::redirect('products/earringSaleOff/');
    }
    ...
    public function action_search() {
        ...
        $total_items = Model_Tproduct::countProductsByName(Input::post('txt_search'), 6);
        $config      = array(
            'name'           => 'bootstrap3',
            'show_first'     => true,
            'show_last'      => true,
        ...
        $products = Model_Tproduct::getProductsSaleOffByName($pagination, Input::post('txt_search'), 6);
