 ...
 * @license 
 */
class Controller_Products_clock extends Controller_Base {
    ...
    public function action_index() {
        ...
        $config = array(
            ...
            'first-marker'   => 'First',
            'last-marker'    => 'Last',
            'pagination_url' => 'http://localhost:8080/saleonline/html/products/clock/',
        ...
        $tproduct   = Model_Tproduct::getProductsByName($pagination, Input::post('txt_search'), 1);

        $view                         = View::forge('products/clock/index');
        $view->clocks                 = $tproduct;
        $view->pagination             = $pagination;
        $this->template->title        = "Đồng hồ";
    ...
    public function action_cart($id = null) {
        ...
        Response::redirect('products/clock/');
    }
