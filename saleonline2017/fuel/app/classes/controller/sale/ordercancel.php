...
class Controller_Sale_OrderCancel extends Controller_Base {
    ...
    public function action_index() {
        $view   = View::forge('account/sale/ordercancel/index');
        //Model_Account::getOrder();
        $orders = Model_Torder::getLstOrderCancel(); //getLstOrder();
    ...
    public function action_search() {
        ...
        $rsOrders                = Model_Torder::searchOrderCancel($oder_id, $customer, $order_status);
     ...
     *
     */
    public function action_recoveryOrder() {
