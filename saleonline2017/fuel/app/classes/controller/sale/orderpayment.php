...
class Controller_Sale_OrderPayment extends Controller_Base {
    ...
    public function action_index() {
        $view   = View::forge('account/sale/orderpayment/index');
        //Model_Account::getOrder();
        $orders = Model_Torder::getLstOrderPayment(); //getLstOrder();
    ...
    public function action_search() {
        ...
        $rsOrders                = Model_Torder::searchOrderPayment($oder_id, $customer, $order_status);
    ...
    public function action_paymentOrder() {
