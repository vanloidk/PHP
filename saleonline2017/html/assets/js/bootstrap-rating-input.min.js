!function (a)
{
    ...
    var f = "rating-clear", g = "." + f, h = "hidden", i = {min: 1, max: 5, "empty-value": 0, iconLib: "glyphicon", activeIcon: "glyphicon-star", inactiveIcon: "glyphicon-star-empty", clearable: !1, clearableIcon: "glyphicon-remove", clearableRemain: !1, inline: !1, readonly: !1},
    j = function (a, b) {
        var c = this.$input = a;
        this.options = d(c, b);
    ...
    j.VERSION = "0.4.0", j.DEFAULTS = i, j.prototype = {clear: function () {
    ...
    var k = a.fn.rating = function (c) {
        return this.filter("input[type=number]").each(function () {
            ...
            f.options.readonly || f.$el.on("mouseenter", b(),
                    function () {
